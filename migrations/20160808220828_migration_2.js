exports.up = function(knex, Promise) {  
  ...
  // ________________________________________________________
    ...
    knex.schema.createTable('users_conversations', function(table) {
      table.increments();
      table.integer('user_conversation_id').references('conversations.id').notNullable();
    ...
    knex.schema.createTable('chats', function(table) {
      table.increments();
      table.integer('room_id').references('conversations.id').notNullable();
